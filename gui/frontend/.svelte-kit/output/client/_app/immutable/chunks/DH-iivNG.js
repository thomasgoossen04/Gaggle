...
var _a, _b;
import { n as noop$1, s as safe_not_equal, o as onMount, t as tick } from "./BOkfkSpx.js";
class HttpError {
  /**
   * @param {number} status
...
const base = ((_a = globalThis.__sveltekit_1ng2rqz) == null ? void 0 : _a.base) ?? "";
const assets = ((_b = globalThis.__sveltekit_1ng2rqz) == null ? void 0 : _b.assets) ?? base ?? "";
const version = "1770121527481";
...
async function start(_app, _target, hydrate) {
  ...
  if ((_a2 = globalThis.__sveltekit_1ng2rqz) == null ? void 0 : _a2.data) {
    globalThis.__sveltekit_1ng2rqz.data;
  }
  if (document.URL !== location.href) {
    location.href = location.href;
  }
  app = _app;
  await ((_c = (_b2 = _app.hooks).init) == null ? void 0 : _c.call(_b2));
  routes = parse(_app);
