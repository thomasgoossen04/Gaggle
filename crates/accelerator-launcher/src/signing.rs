...
//!
//! Every `latest.json` this launcher fetches over the network is accompanied by
...
//! which binary gets downloaded, made executable, and `exec`'d — TLS to GitHub
//! alone doesn't cover a compromised release asset, a tampered descriptor, or
//! an `http://` override.
